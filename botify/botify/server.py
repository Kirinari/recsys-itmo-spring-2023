...
from botify.recommenders.toprecommender import TopRecommender
...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        treatment = Experiments.TOPRECOMMENDER.assign(user)
        if treatment == Treatment.T1:
            recommender = TopRecommender(tracks_with_diverse_recs_redis.connection, catalog, user_tracks, user_artists)
        else:
